...
| 远端 workflow 运行 | 0 | [Verify #1](https://github.com/RsLuna7/reade/actions/runs/34037890510) `conclusion=success`（2026-09-06）。Frontend / Rust Windows（含 `dtolnay/rust-toolchain@1.94.0`）/ deps-audit（含 `taiki-e/install-action` `cargo-audit@0.22.2`）三作业全绿。本机 `gh` 未登录，PR 未开；compare：https://github.com/RsLuna7/reade/compare/main...feature/oxx |
